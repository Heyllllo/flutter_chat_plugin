...
class ChatTheme {
  ...
  factory ChatTheme.fromTheme(ThemeData theme) {
    return ChatTheme(
      ...
      botBubbleColor: theme.colorScheme.surfaceVariant,
  ...
  ChatTheme merge(ChatTheme? other) {
    ...
    return ChatTheme(
      ...
      sendButtonDisabledColor: other.sendButtonDisabledColor ?? sendButtonDisabledColor,
      loadingIndicatorColor: other.loadingIndicatorColor ?? loadingIndicatorColor,
      backgroundColor: other.backgroundColor ?? backgroundColor,
      userBubbleBorderRadius: other.userBubbleBorderRadius ?? userBubbleBorderRadius,
      botBubbleBorderRadius: other.botBubbleBorderRadius ?? botBubbleBorderRadius,
    );
  }
  ...
  TextStyle getUserTextStyle(ThemeData appTheme) {
    return userTextStyle ?? TextStyle(
      color: userBubbleColor != null 
          ? ThemeData.estimateBrightnessForColor(userBubbleColor!) == Brightness.dark 
              ? Colors.white 
              : Colors.black
  ...
  TextStyle getBotTextStyle(ThemeData appTheme) {
    return botTextStyle ?? TextStyle(
      color: botBubbleColor != null 
          ? ThemeData.estimateBrightnessForColor(botBubbleColor!) == Brightness.dark 
              ? Colors.white 
              : Colors.black
